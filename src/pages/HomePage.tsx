...
export function HomePage() {
  return (
    <PageContainer>
      <section className="grid h-[262px] grid-cols-[minmax(320px,419px)_minmax(420px,562px)] items-center gap-[57px] max-[1200px]:h-auto max-[1200px]:grid-cols-1 max-[1200px]:gap-6 max-[1200px]:py-12 max-[1200px]:pb-7 max-[560px]:py-8">
        <div className="pt-10 max-[1200px]:pt-0">
          <h1 className="m-0 mb-[21px] text-[32px] leading-[1.12] font-semibold tracking-[0.32px] text-black max-[560px]:text-[28px]">
      ...
      <section className="pt-4" aria-labelledby="recent-title">
        ...
        <div className="mt-[26px] grid grid-cols-[repeat(auto-fit,minmax(min(235px,100%),235px))] gap-x-8 gap-y-[21px] max-[560px]:grid-cols-1">
