  ...
  return (
    <Dialog.Root onOpenChange={onOpenChange} open={open}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-50 w-120 max-w-[calc(100vw-32px)] -translate-x-1/2 -translate-y-1/2 rounded-[10px] border border-[#d2d8e5] bg-white p-7 shadow-[0_16px_40px_rgba(15,23,42,0.18)]">
          <Dialog.Title className="m-0 text-[22px] font-normal text-[#3c4043]">
            {mode === 'move' ? 'Move form' : 'Save draft'}
          </Dialog.Title>
          <Dialog.Description className="mt-1 text-[13px] text-[#726f6f]">
            {mode === 'move'
          ...
          <div className="mt-6 flex items-center justify-between gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Dialog.Close asChild>
                <button
                  className="inline-flex h-9.5 cursor-pointer items-center justify-center rounded-[5px] border-0 bg-transparent px-4 text-[14px] font-semibold tracking-[0.14px] text-[#726f6f] transition-colors hover:bg-[#f7f8fb]"
                  type="button"
                >
                  Cancel
                </button>
              ...
              <button
                className="inline-flex h-9.5 cursor-pointer items-center justify-center rounded-[5px] border-0 bg-[#1e55c5] px-5 text-[14px] font-semibold tracking-[0.14px] text-white transition-colors hover:bg-[#1a49aa]"
